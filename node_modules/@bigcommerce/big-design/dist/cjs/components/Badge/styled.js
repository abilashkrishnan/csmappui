...
const StyledBadge = /*#__PURE__*/_styledComponents.default.span.withConfig({
  displayName: "styled__StyledBadge",
  componentId: "sc-1oik56k-0"
})(["", ";color:", ";border-radius:", ";display:inline-block;font-size:", ";font-weight:", ";line-height:", ";text-align:center;text-transform:uppercase;padding:0 ", ";", " ", " ", " ", " ", ""], (0, _mixins.withMargins)(), _ref => {
  let {
    theme
  } = _ref;
  ...
  return variant === 'primary' && (0, _styledComponents.css)(["background-color:", ";"], theme.colors.primary40);
});
