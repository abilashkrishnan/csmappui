...
exports.TableNext = exports.TableFigureNext = void 0;
...
const InternalTableNext = props => {
  ...
  } = (0, _hooks.useSelectable)(selectable);
  const {
    expandedRows,
    getChildren,
    isExpandable,
    onExpandedRow,
    setExpandedRows
  } = (0, _hooks.useExpandable)(expandable);
  ...
  }), getChildren !== undefined && /*#__PURE__*/_react.default.createElement(_HeaderCell2.ExpandableHeaderCell, {
    actionsRef: actionsRef,
    headerCellIconRef: headerCellIconRef
  ...
  const renderDroppableItems = () => /*#__PURE__*/_react.default.createElement(_reactBeautifulDnd.Droppable, {
    ...
    const pagedIndex = (0, _helpers.getPagedIndex)(index, pagination);
    return /*#__PURE__*/_react.default.createElement(_reactBeautifulDnd.Draggable, {
      draggableId: String(key),
      index: index,
      key: key
    }, (provided, snapshot) => /*#__PURE__*/_react.default.createElement(_RowContainer.RowContainer, (0, _extends2.default)({
  ...
  const renderItems = () => onRowDrop ? renderDroppableItems() : /*#__PURE__*/_react.default.createElement(_Body.Body, {
    ...
    const key = getItemKey(item, index);
    const pagedIndex = (0, _helpers.getPagedIndex)(index, pagination);
    return /*#__PURE__*/_react.default.createElement(_RowContainer.RowContainer, {
      columns: columns,
      expandedRows: expandedRows,
      getChildren: getChildren,
      getItemKey: getItemKey,
...
const TableNext = (0, _utils.typedMemo)(InternalTableNext);
exports.TableNext = TableNext;
const TableFigureNext = /*#__PURE__*/(0, _react.memo)(props => /*#__PURE__*/_react.default.createElement(_styled.StyledTableFigure, props));
exports.TableFigureNext = TableFigureNext;