...
exports.StyledButton = exports.LoadingSpinnerWrapper = exports.ContentWrapper = void 0;
...
const StyledButton = /*#__PURE__*/_styledComponents.default.button.withConfig({
  ...
  return icon && (0, _styledComponents.css)(["padding:0;min-width:", ";"], (0, _bigDesignTheme.addValues)(theme.spacing.xxLarge, theme.spacing.xxSmall));
}, _ref18 => {
  let {
    iconLeft,
    theme
...
const ContentWrapper = /*#__PURE__*/_styledComponents.default.span.attrs({}).withConfig({
  ...
  return isLoading && (0, _styledComponents.css)(["visibility:hidden;"]);
});
exports.ContentWrapper = ContentWrapper;
const LoadingSpinnerWrapper = /*#__PURE__*/(0, _styledComponents.default)(_Flex.Flex).withConfig({
...
const ButtonPrimary = /*#__PURE__*/(0, _styledComponents.css)(["background-color:", ";border-color:", ";font-weight:", ";&:active{background-color:", ";}&:focus{box-shadow:", ";}&:hover:not(:active){background-color:", ";}&[disabled]{background-color:", ";}"], _ref22 => {
  let {
    theme
  } = _ref22;
...
const ButtonPrimaryDestructive = /*#__PURE__*/(0, _styledComponents.css)(["background-color:", ";border-color:", ";font-weight:", ";&:active{background-color:", ";}&:focus{box-shadow:", ";}&:hover:not(:active){background-color:", ";}&[disabled]{background-color:", ";}"], _ref29 => {
  let {
    theme
  } = _ref29;
...
const ButtonSecondary = /*#__PURE__*/(0, _styledComponents.css)(["background-color:transparent;border-color:", ";color:", ";&:active{background-color:", ";}&:focus{box-shadow:", ";}&:hover:not(:active){background-color:", ";}&[disabled]{color:", ";}"], _ref36 => {
  let {
    theme
  } = _ref36;
  return theme.colors.primary;
...
const ButtonSecondaryDestructive = /*#__PURE__*/(0, _styledComponents.css)(["background-color:transparent;border-color:", ";color:", ";&:active{background-color:", ";}&:focus{box-shadow:", ";}&:hover:not(:active){background-color:", ";}&[disabled]{color:", ";}"], _ref42 => {
  let {
    theme
  } = _ref42;
  return theme.colors.danger;
...
const ButtonSubtle = /*#__PURE__*/(0, _styledComponents.css)(["background-color:transparent;border-color:transparent;color:", ";&:active{background-color:", ";}&:focus{box-shadow:", ";}&:hover:not(:active){background-color:", ";}&[disabled]{border-color:transparent;color:", ";}"], _ref48 => {
  let {
    theme
  } = _ref48;
  return theme.colors.primary;
...
const ButtonSubtleDestructive = /*#__PURE__*/(0, _styledComponents.css)(["background-color:transparent;border-color:transparent;color:", ";&:active{background-color:", ";}&:focus{box-shadow:", ";}&:hover:not(:active){background-color:", ";}&[disabled]{border-color:transparent;color:", ";}"], _ref53 => {
  let {
    theme
  } = _ref53;
  return theme.colors.danger;
