...
const StyleableInput = _ref => {
  ...
  const uniqueInputId = (0, _react.useId)();
  ...
  const renderedIconLeft = (0, _react.useMemo)(() => {
    if (!props.iconLeft) {
      return null;
    }
  ...
  const renderedIconRight = (0, _react.useMemo)(() => {
    if (!props.iconRight) {
      return null;
    }
    return /*#__PURE__*/_react.default.createElement(_styled.StyledIconWrapper, {
  ...
  const renderedChips = (0, _react.useMemo)(() => {
    if (!chips) {
      return null;
    }
    return chips.map(chip => /*#__PURE__*/_react.default.createElement(_Chip.Chip, (0, _extends2.default)({}, chip, {
      key: chip.label,
      marginBottom: "none"
    })));
  }, [chips]);
...
const Input = (0, _utils.typedMemo)( /*#__PURE__*/(0, _react.forwardRef)((_ref2, ref) => {
  let {
    className,
    style,
    ...props
