...
const ButtonGroup = /*#__PURE__*/(0, _react.memo)(_ref2 => {
  let {
    actions,
    ...wrapperProps
  } = _ref2;
  ...
  const [actionsState, setActionsState] = (0, _react.useState)([]);
  (0, _react.useEffect)(() => {
  ...
  const hideOverflowedActions = (0, _react.useCallback)(() => {
  ...
  const renderedDropdown = (0, _react.useMemo)(() => /*#__PURE__*/_react.default.createElement(_styled.StyledFlexItem, {
  ...
  const renderedActions = (0, _react.useMemo)(() => [...actionsState].reverse().sort(_ref8 => {
    let {
      isVisible
    } = _ref8;
