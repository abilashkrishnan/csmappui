...
export declare const ExpandableHeaderCell: React.FC<DragIconCellProps>;
export declare const HeaderCell: <T extends TableItem>({ actionsRef, children, column, display, hide, id, isSorted, onSortClick, sortDirection, stickyHeader, }: HeaderCellProps<T>) => React.JSX.Element;
